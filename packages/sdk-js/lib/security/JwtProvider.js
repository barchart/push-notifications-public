...
module.exports = (() => {
	...
	class JwtProvider extends Disposable {
		 ...
		 * @returns {JwtProvider}
		 */
		static forStaging(userId, contextId) {
			return getJwtProviderForImpersonation(Configuration.getJwtImpersonationHost, 'stage', userId, contextId);
		}
	...
	function getJwtProviderForImpersonation(host, environment, userId, contextId) {
